...
On demo-start branch the regression test file does NOT exist yet — agent should add it during fix. After fix: `yarn test packages/utils/geometry/rotation-selection.test.ts --watch=false`
